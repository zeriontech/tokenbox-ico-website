...
<head>
  ...
  <link rel="apple-touch-icon" href="/favicon-195.png" sizes="195x195">

  <link rel="stylesheet" href="/assets/front/css/app.css?v=8">
...
<body>
  ...
  <script type="text/javascript" src="/assets/front/js/app.min.js?v=4"></script>
</body>
</html>
