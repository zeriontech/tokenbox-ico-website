...
@section('content')
  ...
  <div class="header-wrapper">
    @component('shared/header')
      @slot('mobile')
        <li><a href="/">{{__('Learn about Tokenbox')}}</a></li>
        <li><a href="/">{{__('Tokenbox TGE crowdsale starts on 14 November')}}</a></li>
      @endslot

      <nav class="nav js-scroll-nav" role="navigation">
        <li><a href="/">{{__('Learn about Tokenbox')}}</a></li>
        <li><a href="/">{{__('Tokenbox TGE crowdsale starts on')}} <b>{{__('14 November')}}</b></a></li>
      </nav>
