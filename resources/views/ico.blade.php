...
@if(app('request')->input('started'))
      ...
      <p style="font-size:2.6em;">{!!__('Got questions?')!!} <b><a href="{!!__('/docs/Tokenbox-TGE-Guide-En.pdf')!!}" target="_blank">{!!__('See the detailed guide.')!!}</a></p><p>{!!__('If you decide to purchase more tokens, repeat steps 3-4 by signing-in to your <a href="https://tokebox.zerion.io/" target="_blank">dashboard</a>.')!!}</p>
@else
