...
t.$prevArrow.removeClass("slick-disabled").attr("aria-disabled","false")):t.currentSlide>=t.slideCount-1&&t.options.centerMode===!0&&(t.$nextArrow.addClass("slick-disabled").attr("aria-disabled","true"),t.$prevArrow.removeClass("slick-disabled").attr("aria-disabled","false")))},t.prototype.updateDots=function(){var e=this;null!==e.$dots&&(e.$dots.find("li").removeClass("slick-active").attr("aria-hidden","true"),e.$dots.find("li").eq(Math.floor(e.currentSlide/e.options.slidesToScroll)).addClass("slick-active").attr("aria-hidden","false"))},t.prototype.visibility=function(){var e=this;e.options.autoplay&&(document[e.hidden]?e.interrupted=!0:e.interrupted=!1)},e.fn.slick=function(){var e,n,i=this,o=arguments[0],r=Array.prototype.slice.call(arguments,1),s=i.length;for(e=0;e<s;e++)if("object"==typeof o||"undefined"==typeof o?i[e].slick=new t(i[e],o):n=i[e].slick[o].apply(i[e].slick,r),"undefined"!=typeof n)return n;return i}}),sr.tools.isMobile()||(sr.reveal(".from-bottom",{distance:"-50px",origin:"top"}),sr.reveal(".topblock .fade-in-item",{viewFactor:0},100),sr.reveal(".technology .fade-in-item",{viewFactor:0},100),sr.reveal(".get-notified"),sr.reveal(".invest-in-pro"),sr.reveal(".pay-with"),sr.reveal(".become-legal"),sr.reveal(".trading-app"),sr.reveal(".issue"),sr.reveal(".big-title"),sr.reveal(".send-request-body"),sr.reveal(".roadmap .top"),sr.reveal(".technology"),sr.reveal(".team .member",{distance:"-50px",origin:"top"},100),sr.reveal(".advisors .member",{distance:"-50px",origin:"top"},100),sr.reveal(".pay-with-screen",{distance:"50px"},150),sr.reveal(".multi-crypto"),sr.reveal(".media"),sr.reveal(".footer"),sr.reveal(".footer-social .link",50),sr.reveal(".background-icon",{scale:.1,easing:"ease-in-out"}),sr.reveal(".fade-in-left",{distance:"50px",origin:"left"}),sr.reveal(".fade-in-right",{distance:"50px",origin:"right"})),$(document).ready(function(){$(".hamburger-icon").each(function(){var e=$(this);e.click(function(){return e.toggleClass("active"),e.hasClass("active")?$("html, body").css("overflow","hidden"):$("html, body").css("overflow",""),e.next().toggleClass("opened"),!1})}),$(".js-ajax-form").submit(function(){var e=$(this),t=e.find("button"),n=t.text();return $.ajax({url:e.data("extra-action"),type:e.attr("method"),data:e.serialize()}),$.ajax({url:e.attr("action"),type:e.attr("method"),data:e.serialize(),cache:!1,dataType:"json",contentType:"application/json; charset=utf-8"}).done(function(i){return"error"==i.result?($(".notification.error").html(i.msg).fadeIn(),setTimeout(function(){$(".notification.error").fadeOut()},3e3),t.html(n)):(t.html("Check your email...").addClass("button-waiting"),void localStorage.setItem("waitedForm","#"+e.attr("id")))}).fail(function(){t.html("Error, try later")}),t.html('<div class="button-loader"></div>'),!1}),$(".js-modal-link").click(function(){var e=$($(this).data("target"));return openModal(e),!1}),$(".js-tabs").each(function(){var e=$(this).find(".js-tab");$(this).find(".tabs a").click(function(t){return e.hide(),$($(this).attr("href")).fadeIn(600),$(this).siblings().removeClass("current"),$(this).addClass("current"),!1})}),$('.js-scroll-nav a[href^="#"]').click(function(){var e=$(this).attr("href");return $(".hamburger-icon").hasClass("active")&&setTimeout(function(){$(".hamburger-icon").trigger("click")},300),$("html").animate({scrollTop:$(e).offset().top},700),setTimeout(function(){window.location.hash=e},300),!1}),$(".slider").slick({autoplay:!0,arrows:!1,dots:!0,fade:!0,speed:500,autoplaySpeed:7e3}),$(".dropdown .title").click(function(){$(this).closest(".dropdown").toggleClass("opened")})}),window.addEventListener("storage",function(e){"emailConfirmed"==e.key&&$(".button-waiting").removeClass("button-waiting").text("Thank you").addClass("button-success")}),$(window).on("load",function(){if(location.search.search("confirmed")!=-1){var e=localStorage.getItem("waitedForm");if(e){var t=$(e);if(0!=t.length){t.is(":hidden")&&t.closest(".modal").length&&openModal(t.closest(".modal"));var n=t.find(".button");n.html('<div class="button-loader"></div>').addClass("button-waiting"),$("html").animate({scrollTop:t.offset().top-100},700,function(){setTimeout(function(){window.localStorage.setItem("emailConfirmed",!0),n.removeClass("button-waiting").text("Thank you").addClass("button-success")},1e3)})}}}}),function(){function e(e,t,n){return'      <div class="countdown-item" data-key="'+e+'">        <svg viewPort="0 0 0 0" version="1.1" xmlns="http://www.w3.org/2000/svg">          <circle class="inner-bar"></circle>          <circle class="bar"></circle>        </svg>        <div class="countdown-item-text">0</div>        <div class="countdown-item-label">'+e[0].toUpperCase()+e.slice(1)+"</div>      </div>    "}function t(){var e=r(s);$(".countdown-item").each(function(){var t=$(this).find(".bar"),i=$(this).find(".countdown-item-text"),o=$(this).data("key"),r=e[o],s=parseInt(t.css("r")),l=Math.PI*(2*s),c=(r/a[o]+.01)*l;t.css({strokeDashoffset:.01}),n(i,r),t.animate({strokeDashoffset:c},1e3,function(){$(this).addClass("loaded")})})}function n(e,t){setTimeout(function(){+e.text()!=t&&(e.text(+e.text()+1),n(e,t))},20)}function i(){var t=r(s),n=l.map(function(n){return e(n,t[n],n)}).join("");$("#countdown").html(n)}function o(){var e=r(s);$(".countdown-item").each(function(){var t=$(this).data("key"),n=e[t],i=$(this).find(".bar"),o=parseInt(i.css("r"),10),r=Math.PI*(2*o),s=(n/a[t]+.01)*r;i.css({strokeDashoffset:s});var l=$(this).find(".countdown-item-text");l.text(n),l.text()!=n&&(l.addClass("-hidden"),setTimeout(function(){l.removeClass("-hidden")},200))})}function r(e){var t=Date.parse(e)-Date.parse(new Date),n=Math.floor(t/1e3%60),i=Math.floor(t/1e3/60%60),o=Math.floor(t/36e5%24),r=Math.floor(t/864e5);return{total:t,days:r,hours:o,minutes:i,seconds:n}}if($(".countdown").is(":visible")){var s=new Date(2017,9,24,12),a={days:60,hours:24,minutes:60,seconds:60},l=["days","hours","minutes","seconds"];i(),setTimeout(function(){t(),setInterval(o,1500)},400)}}(),$(function(){$("#mc-embedded-subscribe-form-1").submit(function(){dataLayer.push({event:"custom_event",event_id:"top",event_name:"form"})}),$("#mc-embedded-subscribe-form-2").submit(function(){dataLayer.push({event:"custom_event",event_id:"middle",event_name:"form"})}),$("#mc-embedded-subscribe-form-3").submit(function(){dataLayer.push({event:"custom_event",event_id:"bottom",event_name:"form"})}),$("#presale-form").submit(function(){dataLayer.push({event:"custom_event",event_id:"modal",event_name:"presale"})})});
